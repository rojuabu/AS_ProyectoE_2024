...
c("Cuadrícula, dos dimensiones", mse_vid(normalized_matrices_list[[1]],comprimido_concat_2d),"---"),
c("Cuadrícula, una dimensión", mse_vid(normalized_matrices_list[[1]],comprimido_concat_1d),"---")   ) )
