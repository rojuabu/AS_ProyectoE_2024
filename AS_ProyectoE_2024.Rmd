...
```{r 5_3_4_visualizar_matrices_RGB, echo=TRUE}
...
DEJO ESTO DE CÓDIGO POR SI ACASO, PERO BORRAR COMENTADO SI NO HACE FALTA DESPUÉS
...
Veamos las funciones en R que comprimen los coeficiente wavelet:

Compresión de paso bajo:

```{r 6_a_funcion_compresion_paso_bajo, echo=TRUE}
...
Compresión de paso bajo 2 (Ajustable):

```{r 6_a_funcion_compresion_paso_bajo2, echo=TRUE}
...
video_base <- rec_vid(dwt2d_videos[[1]], trans = FALSE)

video_base_trans <- rec_vid(dwt_trans_2d_videos[[1]], trans = TRUE)

wavelet_comprimido_paso_bajo <- comp_vid_paso_bajo(dwt2d_videos[[1]])
video_paso_bajo <- rec_vid(wavelet_comprimido_paso_bajo, trans = FALSE)

wavelet_comprimido_paso_bajo_trans <- comp_vid_paso_bajo(dwt_trans_2d_videos[[1]])
video_paso_bajo_trans <- rec_vid(wavelet_comprimido_paso_bajo_trans, trans = TRUE)

wavelet_comprimido_paso_bajo2 <- comp_vid_paso_bajo2(dwt2d_videos[[1]], q = 0.5)
video_paso_bajo2 <- rec_vid(wavelet_comprimido_paso_bajo2, trans = FALSE)

wavelet_comprimido_paso_bajo2_trans <- comp_vid_paso_bajo2(dwt_trans_2d_videos[[1]], q = 0.5)
video_paso_bajo2_trans <- rec_vid(wavelet_comprimido_paso_bajo2_trans, trans = TRUE)
```
...
error_compresion(normalized_matrices_list[[1]],video_base)
print("Método: Matrices transicionales sin compresión.")
error_compresion(normalized_matrices_list[[1]],video_base_trans)
print("Método: Fotograma a fotograma con filtro de paso bajo.")
error_compresion(normalized_matrices_list[[1]],video_paso_bajo)
print("Método: Matrices transicionales con filtro de paso bajo.")
error_compresion(normalized_matrices_list[[1]],video_paso_bajo_trans)
print("Método: Fotograma a fotograma con filtro de paso bajo 2.")
error_compresion(normalized_matrices_list[[1]],video_paso_bajo_2)
print("Método: Matrices transicionales con filtro de paso bajo 2.")
error_compresion(normalized_matrices_list[[1]],video_paso_bajo_2_trans)
