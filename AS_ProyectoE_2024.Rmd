...
aplicar_wavelet_a_matriz_por_filas <- function(matriz, filtro_wavelet = "haar") {
...
extraccion_wavelet_por_filas <- function(array_imagen, filtro_wavelet = "haar") {
...
resultado_arbol_01 <- extraccion_wavelet(arbol_01)
