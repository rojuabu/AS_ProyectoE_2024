...
```{r 2_2_2_aplicar_a_concatenar_correccion, echo=FALSE, include=FALSE}
matriz_imagen <- perro_01
...
```{r 5_1_3_1_visualizacion_fotogramas_extraidos, echo=TRUE}
...
```{r 6_b_funcion_medición_error, echo=TRUE}
...
error_compresion_silent <- function(vid1, vid2) {
  return( list(MSE_vid = mse_vid(vid1, vid2), MSE_last= mse_imags(vid1[[length(vid1)]], vid2[[length(vid1)]], bn = FALSE)))
}
```
